...
var main = async () => {
  run({
    ...
    deleteLabel: getInput("delete_label") === "true",
    repositoryOwner: getInput("repository_owner"),
    repositoryName: getInput("repository_name"),
...
var run = async (input) => {
  ...
  setOutput("label_name", label);
  await triggerWorkflowByLabel(input, label);
};
var triggerWorkflowByLabel = async (input, label) => {
